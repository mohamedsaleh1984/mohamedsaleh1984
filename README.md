...
[.NET Microservices for Azure Developers](<./certs/.NET Microservices for Azure Developers.pdf>)

[Advanced Azure Microservices with .NET for Developers](<./certs/Advanced Azure Microservices with .NET for Developers.pdf>)

[Advanced SQL Logical Query Processing Part 1](<./certs/Advanced SQL Logical Query Processing Part 1.pdf>)

[Advanced SQL Logical Query Processing Part 2](<./certs/Advanced SQL Logical Query Processing Part 2.pdf>)

[Machine Learning Foundations Calculus](<./certs/Machine Learning Foundations Calculus.pdf>)
